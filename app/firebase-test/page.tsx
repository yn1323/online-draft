        ...
        {testResults && (
          <VStack gap={4} align="stretch">
            ...
            >
              <Text
                fontWeight="bold"
                color={testResults.auth ? 'green.800' : 'red.800'}
                _dark={{ color: testResults.auth ? 'green.200' : 'red.200' }}
              >
            ...
            >
              <Text
                fontWeight="bold"
                color={testResults.firestore ? 'green.800' : 'red.800'}
                _dark={{
                  color: testResults.firestore ? 'green.200' : 'red.200',
                }}
              >
