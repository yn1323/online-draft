...
- Name: ロビーからドラフトページへの画面遷移 >> 新規ユーザー作成後、ドラフトページへ遷移する
- Location: /home/runner/work/online-draft/online-draft/e2e/tests/lobby-to-draft-navigation.test.ts:6:7
...
Call log:
  - waiting for getByRole('button', { name: '新しいユーザーを作成' })
    ...
    at /home/runner/work/online-draft/online-draft/e2e/tests/lobby-to-draft-navigation.test.ts:13:24
```
