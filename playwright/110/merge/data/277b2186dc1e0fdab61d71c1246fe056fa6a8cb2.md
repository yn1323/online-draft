...
+**目標**: 2層認証システムの完全実装��DraftPage認証統合
+**実装期間**: 2025/6/12（完了）
+
+#### ✅ 完了機能（Step 1-3）
...
+
+    await expect(
+      page.getByRole('heading', { name: 'グループ���見つかりません' }),
+    ).toBeVisible();
+  });
+});
...
-  );
-};
diff --git a/src/components/features/draft/DraftPage/components/SelectionButton/index.tsx b/src/components/features/draft/DraftPage/components/SelectionButton/index.tsx
deleted file mode 100644
index 33a2c9f..0000000
--- a/src/components/features/draft/DraftPage/components/SelectionButton/index.tsx
+++ /dev/null
@@ -1,48 +0,0 @@
-import { COMPONENT_THEMES } from '@/src/constants/theme';
-import { Button } from '@chakra-ui/react';
...
-  );
-};
diff --git a/src/components/features/draft/DraftPage/components/SelectionPreview/index.tsx b/src/components/features/draft/DraftPage/components/SelectionPreview/index.tsx
deleted file mode 100644
index 1c19a4d..0000000
--- a/src/components/features/draft/DraftPage/components/SelectionPreview/index.tsx
+++ /dev/null
@@ -1,80 +0,0 @@
