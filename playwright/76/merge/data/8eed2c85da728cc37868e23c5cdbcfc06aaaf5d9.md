...
- Name: 参加者シナリオ >> 参加フォームのバリデーション
- Location: /home/runner/work/online-draft/online-draft/e2e/tests/participant-journey.test.ts:162:7
...
Call log:
  ...
  - attempting click action
    ...
    at /home/runner/work/online-draft/online-draft/e2e/tests/participant-journey.test.ts:167:26
    at /home/runner/work/online-draft/online-draft/e2e/tests/participant-journey.test.ts:165:16
```
...
> 167 |       await submitButton.click();
  ...
  208 |       
  209 |       // コードを入力
  210 |       await codeInput.fill('1234');
  211 |       
  212 |       // URLフィールドに切り替えて入力
  213 |       await urlInput.fill('https://example.com/lobby/test-id');
  214 |       
  215 |       // コードフィールドがクリアされることを確認（実装による）
  216 |       // または両方入力できる場合は、どちらが優先されるか確認
  217 |     });
  218 |   });
  219 | });
```
