import{j as i}from"./create-recipe-context-LbQq3bM7.js";import{w as d,u,s as o,e}from"./index-C0w2AICy.js";import{C,u as R}from"./index-Dgb2xTAI.js";import{V as H}from"./v-stack-DfIdlA7P.js";import{B as S}from"./button-Cus-mLIX.js";import"./jsx-runtime-Bw5QeaCk.js";import"./index-BXymfbzT.js";import"./index-CTqBWVyV.js";import"./factory--2BDjF06.js";import"./index-Dcv8hpMz.js";import"./index-RgLjKqdB.js";import"./responsive-modal-DUYJezqq.js";import"./index-DrVvecys.js";import"./index-DGNrzCve.js";import"./index-DGKHe-6Q.js";import"./index-CrjboX4Z.js";import"./create-slot-recipe-context-BXXlVjN6.js";import"./index-DkeST5JT.js";import"./index-BRNWFSEf.js";import"./text-BOFVnBsW.js";import"./types-DwQkBYn-.js";import"./stack-B-mkjmc_.js";import"./attr-C3Jtgmrz.js";import"./spinner-B1ygD-4y.js";const ot={title:"Features/Top/CreateRoomModal",component:C,parameters:{layout:"centered"}},w=()=>{const{openModal:n,modalProps:m}=R(),a=async t=>{console.log("ルーム作成:",t),alert(`ルーム "${t}" を作成しました！`)};return i.jsxs(H,{gap:4,children:[i.jsx(S,{onClick:n,colorPalette:"blue",size:"lg",children:"ルーム作成モーダルを開く"}),i.jsx(C,{...m,onCreateRoom:a})]})},l={render:()=>i.jsx(w,{}),play:async({canvasElement:n})=>{const a=await d(n).findByText("ルーム作成モーダルを開く");await u.click(a),await new Promise(p=>setTimeout(p,500));const t=await o.findByText("キャンセル");await e(t).toBeInTheDocument();const s=await o.findByText("新しいルームを作成");await e(s).toBeInTheDocument()}},c={render:()=>i.jsx(w,{}),play:async({canvasElement:n})=>{const a=await d(n).findByText("ルーム作成モーダルを開く");await u.click(a),await new Promise(g=>setTimeout(g,500));const t=await o.findByText("新しいルームを作成");await e(t).toBeInTheDocument();const s=await o.findByPlaceholderText("例: 2024年プロ野球ドラフト");await e(s).toBeInTheDocument();const p=await o.findByText("キャンセル"),B=await o.findByText("ルームを作成");await e(p).toBeInTheDocument(),await e(B).toBeInTheDocument(),await e(B).toBeDisabled()}},r={render:()=>i.jsx(w,{}),play:async({canvasElement:n})=>{const a=await d(n).findByText("ルーム作成モーダルを開く");await u.click(a),await new Promise(s=>setTimeout(s,800));const t=await o.findByText("新しいルームを作成");await e(t).toBeInTheDocument()}};var T,x,y;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
