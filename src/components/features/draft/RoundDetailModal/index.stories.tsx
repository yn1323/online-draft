...
const mockRoundData = {
  ...
  topic: '好きな動物',
  selections: [
    { userId: '1', userName: 'あきら', item: 'パンダ', comment: 'かわいいから！' },
    { userId: '2', userName: 'さくら', item: 'うさぎ', comment: 'ふわふわで癒される' },
    { userId: '3', userName: 'ゆうき', item: 'ライオン', comment: 'カッコいいから' },
...
const mockRoundDataLongContent = {
  ...
  selections: [
    { 
      ...
      userName: 'あきら', 
      item: '千と千尋の神隠し', 
      comment: '子供の頃に見て、今でも色褪せない美しい世界観と深いメッセージに感動しました。音楽も素晴らしく、何度見ても新しい発見があります。'
    },
    { 
      userId: '2', 
      userName: 'さくら', 
      item: 'エヴァンゲリオン', 
      comment: '複雑な心理描写と哲学的なテーマが印象的。大人になってから見返すと、また違った解釈ができて面白いです。'
    },
    { 
      userId: '3', 
      userName: 'ゆうき', 
      item: 'ワンピース', 
      comment: '友情と冒険の物語として最高。仲間を思う気持ちや夢を追いかける姿勢に何度も勇気をもらいました。'
    },
    { 
      userId: '4', 
      userName: 'みお', 
      item: '君の名は。', 
      comment: '美しい映像と切ない恋愛ストーリーに心を奪われました。時間と空間を超えた繋がりというテーマが素敵でした。'
    },
  ],
};
...
export const Default: Story = {
  render: (args) => (
    <RoundDetailModalWithControls {...args} />
  ),
  args: {
...
export const PartialSelections: Story = {
  ...
  args: {
    roundData: {
      ...
      topic: '好きな季節',
      selections: [
        { userId: '1', userName: 'あきら', item: '春', comment: '桜が綺麗だから' },
